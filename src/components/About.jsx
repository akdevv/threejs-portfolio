...
function About() {
	...
	const handleCopy = () => {
		navigator.clipboard.writeText("akdevv@protonmail.com");
		setHasCopied(true);
			...
			<div className="grid h-full grid-cols-1 gap-5 xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2">
				...
				<div className="col-span-1 xl:row-span-3">
					<div className="grid-container">
						...
						/>
						<div>
							<p className="grid-headtext">Hi, I&apos;m Ashish</p>
				...
				<div className="col-span-1 xl:row-span-3">
					<div className="grid-container">
						...
						<div>
							...
							<p className="grid-subtext">
								I specialize in React and Next.js frameworks
				...
				<div className="xl:col-span-1 xl:row-span-2">
					<div className="grid-container">
						...
						<div className="space-y-2">
							<p className="text-center grid-subtext">
								Contact Me
							</p>
							<div
